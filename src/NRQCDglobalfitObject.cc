...
//	int MeasurementID=getMeasurementID();
	...
	case 3:
		...
		break;
	case 4:
		dvector PromptProductionRatioDenom = getPromptProduction(getStateDenom(), Op, Np_BR, Np_US);
		...
		break;
	case 5:
		dvector PromptProductionRatioDenom = getPromptProduction(getStateDenom(), Op, Np_BR, Np_US);//Prompt Jpsi
		ModelPrediction=getCorrPromptCrossSect(PromptProduction, Np_BR, Np_US)/getCorrPromptCrossSect(PromptProductionRatioDenom, Np_BR, Np_US);
		break;
	default:
